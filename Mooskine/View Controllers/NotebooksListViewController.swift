...
class NotebooksListViewController: UIViewController, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        let sortDiscription = NSSortDescriptor(key: "creationDate", ascending: false)
    ...
    func addNotebook(name: String) {
        let notebook = Notebook(context: DataController.shared.viewContext)
        notebook.name = name
    ...
    func deleteNotebook(at indexPath: IndexPath) {
        let removeNotebook = notebook(at: indexPath)
